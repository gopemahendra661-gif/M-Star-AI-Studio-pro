...
const PermissionModal: React.FC<PermissionModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-fadeIn">
      <div className="bg-slate-900 border border-slate-700 rounded-2xl max-w-sm w-full p-6 shadow-2xl transform transition-all scale-100 relative">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="w-14 h-14 rounded-full bg-pink-500/10 flex items-center justify-center mb-4 text-pink-500">
          ...
          <h3 className="text-lg font-bold text-white mb-2">Microphone Access Needed</h3>
          
          <p className="text-slate-400 text-sm mb-5 leading-relaxed">
            The app cannot access your microphone. Please allow access to use Voice Input.
          </p>

          <div className="w-full bg-slate-800/50 rounded-lg p-3 text-xs text-left text-slate-300 mb-6 border border-slate-700/50">
            <p className="font-semibold mb-1 text-pink-400">How to fix:</p>
